...
import com.monstahhh.blockmod.blocks.JeffIngot;
...
public class ModItems
{
    ...
    public static JeffIngot jeffIngot = new JeffIngot("jeff_ingot");
    ...
    {
        registry.registerAll(jeffSword, dankCheese, dankCookie, cheeseCookie, jeffPickaxe, itemTransformer, jeffIngot);
    }
